...
| `ec2-image-id`                                                                                                                                                               | Optional. Used only with the `start` mode. | EC2 Image Id (AMI). Take precedence over `ec2-image-name`. <br><br> The new runner will be launched from this image. <br><br> The action is compatible with Amazon Linux 2 images.                                                                                                                                                                                           |
| `ec2-image-name`                                                                                                                                                             | Optional. Used only with the `start` mode. | EC2 AMI Name Filter. <br><br> If more than one result is returned, the most recent AMI will be used.                                                                                                                                                                                          |
